...
\usepackage{nameref}
\usepackage[automark,plainfootsepline]{scrlayer-scrpage} % Kopf- und Fusszeilen
...
\begin{enumerate}
    ...
    \item Eine Personalunion zwischen mehreren Vorstandsämtern ist möglich. Ausgeschlossen ist eine Personalunion zwischen dem Vorstand gem. \S 26 BGB (OG--Satzung \ref{sec:vorstand}, Abs. 3) und dem*der Schatzmeister*in oder Stellvertreter*in.
...
\begin{enumerate}
    ...
    \item \begin{enumerate}[noitemsep]
        ...
        \item Für Wahlen wird grundsätzlich ein Wahlausschuss gebildet; er kann von der*dem anwesenden Vertreter*in des übergeordneten Bezirkes oder des Landesverbandes Niedersachsen~e.V. der DLRG geleitet werden.
      \end{enumerate}
